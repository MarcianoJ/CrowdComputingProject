            ...
            return (<div class="instructions container">
                ...
                <div class="pt-2 row">
                    ...
                    <p>
                        ...
                        <i>I find chess a <mark class="yellow">very boring</mark> game</i> <br/>
                    ...
                    <p>
                        ...
                        <i>I <mark class="yellow">like </mark>hiking through the mountains.</i> <br/>
                    ...
                    <p>
                        ...
                        <i>The man <mark class="yellow">was walking</mark> through the super market.</i> <br/>
                    ...
                    <p>
                        ...
                        <i>The beautiful bicycle was stored in a <mark class="yellow">dark stinky</mark> cellar.</i> <br/>
        ...
        function getEntailmentInstructions() {
            return (<div class="instructions container">
                ...
                <p>
                    ...
                    Context: <i>A man is <mark class="yellow">holding a stick</mark></i> <br/>
                    Statement: <i>A man is standing there  <mark class="yellow">empty handed</mark></i> <br/>
                ...
                <p>
                    <b>Example 3 - neutral</b> <br/>
                    Context: <i><mark class="yellow">The man</mark> was walking through the <mark class="red">super market</mark>.</i> <br/>
                    Statement: <i><mark class="yellow">I</mark> just saw a <mark class="red">squirrel</mark></i><br/>
